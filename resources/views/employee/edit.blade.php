                    ...
                    <form action="{{ route('employee.update', $employee->id_number) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="marital_status" id="marital_status" class="form-control">
                                <option value="" disabled
                                    {{ old('marital_status', $employee->marital_status) == '' ? 'selected' : '' }}>
                                    -Pilih-</option>
                                <option value="Menikah"
                                    {{ old('marital_status', $employee->marital_status) == 'Menikah' ? 'selected' : '' }}>
                                    Menikah</option>
                                <option value="Belum"
                                    {{ old('marital_status', $employee->marital_status) == 'Belum' ? 'selected' : '' }}>
                                    Belum</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" id="mate_name" name="mate_name" value="{{ old('mate_name', $employee->familyData->mate_name ?? '') }}">
                        </div>

                        <div>
                            <label for="child_name">Nama Anak:</label>
                            <input type="text" id="child_name" name="child_name" value="{{ old('child_name', $employee->familyData->child_name ?? '') }}">
                        </div>

                        <div>
                            <label for="wedding_date">Tanggal Menikah:</label>
                            <input type="date" id="wedding_date" name="wedding_date" value="{{ old('wedding_date', $employee->familyData->wedding_date ?? '') }}">
                        </div>

                        <div>
                            <label for="wedding_certificate_number">Nomor Surat Nikah:</label>
                            <input type="text" id="wedding_certificate_number" name="wedding_certificate_number" value="{{ old('wedding_certificate_number', $employee->familyData->wedding_certificate_number ?? '') }}">
                        </div>
